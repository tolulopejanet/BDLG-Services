...
import Online from "../assets/train2.jpeg";
    ...
    <main className="bg-[#030712] text-white">
      <section className="relative overflow-hidden bg-[#070b14] px-6 pb-20 pt-36 text-white md:pb-28">
        ...
        <div className="relative mx-auto grid max-w-7xl items-end gap-12 lg:grid-cols-[1.15fr_.85fr]">
          <div>
            ...
            <h1 className="max-w-4xl text-4xl font-black leading-[.95] tracking-tight md:text-5xl">Learn to fly. Build what&apos;s next.</h1>
      ...
      <section className="px-6 py-20 md:py-28">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 justify-between gap-5 md:flex-row md:items-end">
            <div>
              <p className="text-xs font-bold uppercase tracking-[0.3em] text-blue-400">Our courses</p>
              <h2 className="mt-3 max-w-3xl text-4xl font-black leading-tight md:text-5xl mb-7">Choose your route into the sky.</h2>
              </div>
              <p className=" text-base leading-7 text-gray-400">Personalized attention, field-ready skills, and a training path that grows with your ambition.</p>
              </div>
              <div className="grid gap-px bg-white/10 md:grid-cols-3">{courses.map((course) => <article key={course.code} className="bg-[#030712] p-7 md:p-9"><span className="text-sm font-bold text-blue-400">{course.code}</span><h3 className="mt-16 text-2xl font-black leading-tight">{course.title}</h3><p className="mt-4 leading-7 text-gray-400">{course.detail}</p></article>)}</div></div></section>
